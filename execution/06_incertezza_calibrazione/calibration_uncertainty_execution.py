...
Uso (fai prima un giro di prova con N piccolo!):
    python execution/06_incertezza_calibrazione/calibration_uncertainty_execution.py
"""
import sys
import time
...
CHECKPOINT_PATH = OUT_DIR / "calibration_uncertainty_checkpoint.csv"
THETA_ACC_PATH = OUT_DIR / "theta_acc.csv"
...
result.df_accepted.to_csv(THETA_ACC_PATH, index=False)
print(f"\nTheta_acc salvato in {THETA_ACC_PATH} "
