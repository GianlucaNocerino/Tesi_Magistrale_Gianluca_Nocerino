...
J(theta)) vedi examples/deterministic_calibration_execution.py.

Uso:
    python examples/cost_function_computation.py
"""
import sys
...
# examples/deterministic_calibration_execution.py per l'uso con
