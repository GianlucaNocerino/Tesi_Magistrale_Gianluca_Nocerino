...
examples/morris_screening.py: serve solo per il confronto finale fra i
due ranking, non per il calcolo).

Uso:
    python examples/sobol_analysis.py
...
MORRIS_CSV = "morris_screening.csv"     # solo per il confronto finale
...
INDICES_CSV = "sobol_indices.csv"
CONVERGENCE_CSV = "sobol_convergence.csv"
